...
export class Ken extends Fighter {
    constructor(playerId) {
        ...
        this.frames = new Map ([
            ...
            //Move Backwards
            ['backwards-1', [[[417, 868, 61, 87], [35, 88]], PushBox.IDLE]],
            ['backwards-2', [[[487, 866, 59, 90], [36, 87]], PushBox.IDLE]],
            ['backwards-3', [[[558, 865, 57, 90], [36, 88]], PushBox.IDLE]],
            ['backwards-4', [[[628, 864, 59, 90], [38, 89]], PushBox.IDLE]],
            ...
            ['jump-roll-2', [[[1301, 990, 61, 78], [22, 98]], PushBox.JUMP]],
            ['jump-roll-3', [[[1363, 994, 104, 42], [61, 76]], PushBox.JUMP]],
            ['jump-roll-4', [[[1468, 957, 52, 82], [42, 111]], PushBox.JUMP]],
            ...
            ['jump-up-3', [[[852, 967, 55, 77], [25, 103]], PushBox.JUMP]],
