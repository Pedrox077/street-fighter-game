...
export class Ryu extends Fighter {
    constructor(playerId) {
        ...
        this.frames = new Map ([
            ...
            //Move Forwards
            ['forwards-1', [[[9, 136, 52, 83], [27, 81]], PushBox.IDLE]],
            ['forwards-2', [[[78, 131, 60, 88], [35, 86]], PushBox.IDLE]],
            ...
            //Move Backwards
            ['backwards-1', [[[430, 124, 59, 90], [35, 85]], PushBox.IDLE]],
            ['backwards-2', [[[495, 124, 57, 90], [36, 87]], PushBox.IDLE]],
            ['backwards-3', [[[559, 124, 58, 90], [36, 88]], PushBox.IDLE]],
            ['backwards-4', [[[631, 125, 58, 91], [38, 89]], PushBox.IDLE]],
            ['backwards-5', [[[707, 126, 57, 89], [36, 88]], PushBox.IDLE]],
            ['backwards-6', [[[ 777, 128, 61, 87], [36, 87]], PushBox.IDLE]], 

            
            // Jump Forwards/Backwards
            ['jump-roll-1', [[[375, 244, 55, 109], [25, 106]], PushBox.JUMP]],
            ['jump-roll-2', [[[442, 261, 61, 78], [22, 98]], PushBox.JUMP]],
        ...
        this.animations = {
            [FighterState.IDLE]: [
               ...
               [FighterState.JUMP_FORWARD]: [
                ...
                ['jump-rool-4', 50], ['jump-roll-5', 50], ['jump-roll-6', 50],
                ['jump-roll-7', FrameDelay.TRANSITION],
               ], 
               [FighterState.JUMP_BACKWARD]: [
                ['jump-roll-7', 200], ['jump-roll-6', 50], ['jump-roll-5', 50],
                ['jump-rool-4', 50], ['jump-roll-3', 50], ['jump-roll-2', 50],
                ['jump-roll-1', FrameDelay.TRANSITION],
               ], 
               ...
               [FighterState.IDLE_TURN]: [
                ['idle-turn-3', 33], ['crouch-turn-2', 33],
