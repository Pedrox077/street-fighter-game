...
export class StatusBar {
    constructor(fighters) {
        ...
        this.frames = new Map ([
            ...
            [`${TIME_FRAME_KEYS[0]}-0`, [16, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-1`, [32, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-2`, [48, 32,  12, 14]],
            [`${TIME_FRAME_KEYS[0]}-3`, [64, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-4`, [80, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-5`, [96, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-6`, [112, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-7`, [128, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-8`, [114, 32, 12, 14]],
            [`${TIME_FRAME_KEYS[0]}-9`, [160, 32, 12, 14]],

            
            [`${TIME_FRAME_KEYS[1]}-0`, [16, 192, 10, 12]],
            [`${TIME_FRAME_KEYS[1]}-1`, [34, 192, 7, 12]],
            [`${TIME_FRAME_KEYS[1]}-2`, [48, 192, 11, 12]],
            [`${TIME_FRAME_KEYS[1]}-3`, [16, 192, 11, 12]],
            [`${TIME_FRAME_KEYS[1]}-4`, [16, 192, 11, 12]],
            [`${TIME_FRAME_KEYS[1]}-5`, [16, 192, 11, 12]],
            [`${TIME_FRAME_KEYS[1]}-6`, [16, 192, 10, 12]],
            [`${TIME_FRAME_KEYS[1]}-7`, [16, 192, 11, 12]],
            [`${TIME_FRAME_KEYS[1]}-8`, [16, 192, 10, 12]],
            ...
            ['score-P', [17, 113, 10, 10]],
            ['score-Q', [29, 113, 10, 10]],
            ['score-R', [41, 113, 10, 10]],
            ['score-S', [53, 113, 10, 10]],
            ['score-T', [65, 113, 10, 10]],
            ['score-U', [77, 113, 10, 10]],
            ['score-V', [89, 113, 10, 10]],
            ['score-W', [101, 113, 10, 10]],
            ['score-X', [113, 113, 10, 10]],
            ['score-Y', [125, 113, 10, 10]],
            ['score-Z', [136, 113, 10, 10]],
